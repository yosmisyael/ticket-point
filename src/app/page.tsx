...
import { Menu, X, ChevronRight, Star, MapPin, Calendar, Clock, Search } from 'lucide-react';
...
function Page() {
  ...
  return (
    <main className="overflow-hidden bg-white min-h-screen">
      ...
      <Link href="/" className={`${inter.className} flex items-center space-x-3 rtl:space-x-reverse`} >
        ...
        <nav className={`order-4 w-full lg:w-auto lg:flex flex-wrap gap-3 xl:gap-6 justify-center items-center font-medium text-center tracking-wide ${mobileMenuOpen ? 'flex flex-col items-start pt-4 pb-6' : 'hidden'} lg:flex`}>
          ...
          <button className="w-full lg:w-auto text-left lg:text-center px-5 py-2 text-white rounded-lg bg-primary-mid hover:bg-primary-mid transition-colors duration-300">
            Sign Up
          </button>
        </nav>
      </header>
