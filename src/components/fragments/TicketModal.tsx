        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="relative">
            ...
            <button
              ...
              className={`w-full px-6 py-4 border rounded-xl focus:ring-2 focus:ring-offset-2 transition-all duration-200 ${
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <div className={`text-sm ${currentTier.textColor}`}>{currentTier.price}</div>
                  </div>
                </div>
                <ChevronDown 
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 text-left">
                        ...
                        <div className={`text-sm ${tierData.textColor}`}>{tierData.price}</div>
                      </div>
                      {isSelected && (
            ...
            <div className={`bg-gradient-to-r ${currentTier.color} text-white p-6`}>
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  <span className="text-3xl font-bold">{currentTier.price}</span>
                </div>
              </div>
            </div>
          ...
          >
            <div className="flex items-center justify-center">
              ...
              {isSubmitting ? 'Processing...' : submitSuccess ? 'Ticket Purchased!' : `Purchase ${formData.selectedTier} Ticket - ${currentTier.price}`}
            </div>
          </button>
        </form>
      </div>
