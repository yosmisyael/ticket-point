    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-white bg-opacity-60 backdrop-blur-sm">
      ...
      <style jsx>{`
        ...
        .loader::after {
          ...
          background: linear-gradient(var(--d, 0deg), var(--c2) 50%, transparent 0)
            bottom/100% 205%,
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-16 flex flex-col lg:flex-row min-h-screen">
        {/* Image Section (tampil di layar lg ke atas) */}
        <div
          className="hidden lg:block lg:w-1/2 bg-cover bg-center transition-all duration-500"
          style={{
